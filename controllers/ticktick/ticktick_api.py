...
class TicktickAPI:
    ...
    def login(self, user: str, password: str) -> str:
        ...
        response = self.post(self.signin_url, payload, token_required=False)
        return response["token"]

    def post(self, url: str, data=None, headers=None, token_required: bool = True) -> dict:
        if data is None:
            data = {}
        if headers is None:
            headers = {}
    ...
    def get(self, url: str, data=None, headers=None, token_required: bool = True) -> dict:
        if data is None:
            data = {}
        if headers is None:
            headers = {}
